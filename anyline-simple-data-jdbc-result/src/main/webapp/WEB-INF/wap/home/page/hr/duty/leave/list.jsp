...
<script type="text/javascript">
	...
	function fnSubmitApprove(id, val){
		...
		al.ajax({
			url:'/js/home/hr/duty/lve/apr',
			data:{val:val,reason:reason,id:id},
...
<al:navi url="/web/home/hr/duty/lve/navi" param="fnGetParam" function="fnGloableQuery" body="listBody" page="listPage" intime="true" type="1" auto="true"></al:navi>
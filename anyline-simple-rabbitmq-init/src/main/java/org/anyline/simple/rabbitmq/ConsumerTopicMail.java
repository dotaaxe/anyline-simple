...
public class ConsumerTopicMail {
    ...
    public ConsumerTopicMail(){
        try {
            ...
            //绑定交换机与队列
            channel.queueBind(QUEUE_TOPIC_MAIL, Constant.EXCHANGE_ROUTING, "mail.#");
    ...
    public void start() throws Exception{
        channel.basicConsume(QUEUE_TOPIC_MAIL,true, deliver ,cancel);
    }

    public void receive(String msg){
        System.out.println("receive(topic mail):"+msg);
    }
